def cheat(a, b)
  if a == "cheat"
    puts "You've cheated, Here's the code #{b}."
    return b
  else
    return a
  end
...
class LaserWeaponArmory < Scene
  ...
  def enter()
    ...
    # Below is the test to test the cheat.
    # puts "This is code #{code}."
    print "[keypad]> "
    guess = $stdin.gets.chomp
    guesses = 1
    guess = cheat(guess, code)
    # Prints out what I keyed in
    # puts "This is what I typed in. (#{guess})."
...
class EscapePod < Scene
  ...
  def enter()
    ...
    good_pod = "#{rand(1..5)}"
    # To test cheat
    # puts "This is the number of good pod #{good_pod}."
    print "[pod #]> "
    guess = $stdin.gets.chomp
    guess = cheat(guess, good_pod)
    # To verify what I typed
    # puts "What I typed in (#{guess})."
